...
clothes = ggplot() +
  ...
  coord_fixed()  + scale_fill_viridis() +
  labs(title = expression('GWP per capita household (in kg CO'[2]*' eq/year)'),
       subtitle = "",
       x = "", y = "") + theme_void() +
  theme(plot.title=element_text(size=8,face="bold",hjust=0.35))+
  theme(legend.title = element_blank())+north(consumption_per_buurt) + 
...
detergent = ggplot() +
  ...
  coord_fixed()  + scale_fill_viridis() +
  labs(title = expression('GWP per household household cleaning (in kg CO'[2]*' eq/year)'),
       subtitle = "",
       x = "", y = "") + theme_void() +
  theme(plot.title=element_text(size=8,face="bold",hjust=0.35))+
  theme(legend.title = element_blank())+north(consumption_per_buurt) + 
...
footwear = ggplot() +
  ...
  coord_fixed()  + scale_fill_viridis() +
  labs(title = expression('GWP per household footwear (in kg CO'[2]*' eq/year)'),
       subtitle = "",
       x = "", y = "") + theme_void() +
  theme(plot.title=element_text(size=8,face="bold",hjust=0.35))+
  theme(legend.title = element_blank())+north(consumption_per_buurt) + 
...
furniture = ggplot() +
  ...
  coord_fixed()  + scale_fill_viridis() +
  labs(title = expression('GWP per household furniture (in kg CO'[2]*' eq/year)'),
       subtitle = "",
       x = "", y = "") + theme_void() +
  theme(plot.title=element_text(size=8,face="bold",hjust=0.35))+
  theme(legend.title = element_blank())+north(consumption_per_buurt) + 
...
paper = ggplot() +
  ...
  coord_fixed()  + scale_fill_viridis() +
  labs(title = expression('GWP per household paper products (in kg CO'[2]*' eq/year)'),
       subtitle = "",
       x = "", y = "") + theme_void() +
  theme(plot.title=element_text(size=8,face="bold",hjust=0.35))+
  theme(legend.title = element_blank())+north(consumption_per_buurt) + 
...
Personalcare = ggplot() +
  ...
  coord_fixed()  + scale_fill_viridis() +
  labs(title = expression('GWP per household personal care (in kg CO'[2]*' eq/year)'),
       subtitle = "",
       x = "", y = "") + theme_void() +
  theme(plot.title=element_text(size=8,face="bold",hjust=0.35))+
  theme(legend.title = element_blank())+north(consumption_per_buurt) + 
